        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex flex-column " data-aos="fade-left">
                <div class="content pt-4 pt-lg-0">
                    <p class="fst-italic">
                        Teknologi TPS3R adalah sistem pengolahan sampah dengan inovasi teknologi mesin pencacah sampah dan pengayak kompos yang lebih efektif dan efesien.Teknologi TPS 3R memiliki keunggulan sebagai berikut :
                    </p>
                    <ul>
                        <li><i class="bi bi-check-circle"></i>Mesin pencacah sampah dengan modifikasi pada pisau pencacah sehingga lebih mudah untuk mencacah sampah organik yang bentuknya panjang dan tidak mudah macet.</li>
                        <li><i class="bi bi-check-circle"></i>Mesin pengayak kompos dengan modifikasi berupa ulir yang digunakan untuk mempermudah alur pengayakan sampah tanpa harus di dorong secara manual. Terdapat pilihan roda engkol dimana dapat digunakan secara manual apabila mesin diesel rusak.</li>
                        <li><i class="bi bi-check-circle"></i>Kompos cacing (Kascing) : bahan-bahan mudah didapatkan, peralatan yang digunakan sederhana, cepat memanen hasilnya dan menghasilkan kompos berkualitas tinggi.</li>
                    </ul>
                </div>
            </div>
        </div>
